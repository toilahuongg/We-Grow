      ...
      <div className="space-y-4 pl-5">
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="flex gap-3">
            <div className="h-10 w-10 shrink-0 animate-pulse rounded-full bg-overlay-subtle" />
            <div className="flex-1 space-y-2">
              <div className="h-14 animate-pulse rounded-2xl bg-overlay-subtle" />
              <div className="h-4 w-24 animate-pulse rounded bg-overlay-subtle" />
            </div>
          </div>
        ))}
      </div>
      ...
      {grouped.map((group) => (
        <div key={group.key}>
          ...
          <div className="flex items-center gap-3 mb-1 pl-[52px]">
            ...
            <div className="h-px flex-1 bg-overlay-subtle" />
          </div>
